...
public class Program {
    public static void main(String[] args) {
        ...
        Livro livro1 = new Livro("Duna", 2017, "Brasil", 64.74, 680, "Frank Herbert", 1);
        Livro livro2 = new Livro("Um de nos esta mentindo", 2018, "Brasil", 40.17, 384, "Karen Mcmanus", 1);
        Livro livro3 = new Livro("Mindset Milionario", 2021, "Brasil", 36.46, 272, "José Roberto Marques", 1);

        Dvd dvd1 = new Dvd("Anjos da Noite 5 - Guerras de Sangue", 2016, "Estados Unidos", 20.28, "Anna Foerster", "Ação", 91);
        Dvd dvd2 = new Dvd("Annabelle 2 - A Criacao do Mal", 2017, "Brasil", 47.88, "Jame Wan e Peter Safran", "Terror", 109);
